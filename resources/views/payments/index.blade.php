...
<div class="animate-fade-in space-y-6">
    <div class="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div>
            <h2 class="text-3xl font-bold text-white">Transactions Management</h2>
            <p class="mt-1 text-sm text-white/80">Manage VIP payment transactions and subscriptions</p>
        </div>
    </div>
