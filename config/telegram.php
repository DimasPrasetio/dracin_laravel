...
return [
    ...
    */
    'bots' => [
        'default' => [
            'username' => env('TELE_BOT_USERNAME', 'dracin_indo_bot'),
            'token' => env('TELE_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'admin_id' => env('TELE_ADMIN_ID'),
            'channel_id' => env('TELE_CHANNEL_ID'),
            'commands' => [
                App\Telegram\Commands\StartCommand::class,
                App\Telegram\Commands\VipCommand::class,
                App\Telegram\Commands\HelpCommand::class,
                App\Telegram\Commands\AddMovieCommand::class,
            ],
        ],
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Specify the mode for receiving updates from Telegram.
    |
    | Supported modes:
    | - 'polling': Bot actively polls for updates (requires background process)
    | - 'webhook': Telegram sends updates to your server (requires HTTPS)
    |
    | Default: polling
    |
    */
    'mode' => env('TELE_BOT_MODE', 'polling'),
    ...
    |--------------------------------------------------------------------------
    |
    | The URL where Telegram will send updates when using webhook mode.
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Webhook Certificate Path (Optional)
    |--------------------------------------------------------------------------
    |
    | Path to self-signed certificate if you're using one.
    | Leave empty if using a certificate from a trusted CA.
    |
    */
    'webhook_certificate' => env('TELEGRAM_CERTIFICATE_PATH'),
    ...
    */
    'commands' => [
        // Global commands registered here
    ],
